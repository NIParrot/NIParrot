...
abstract class Utils
{
     ...
     *                          *PREG_SPLIT_NO_EMPTY* If this flag is set, only non-empty pieces will be returned by
     *                          preg_split(). *PREG_SPLIT_DELIM_CAPTURE* If this flag is set, parenthesized expression in
     *                          the delimiter pattern will be captured and returned as well. *PREG_SPLIT_OFFSET_CAPTURE* If
     *                          this flag is set, for every occurring match the appendant string offset will also be
