...
class RouteCollectionTest extends TestCase
{
    ...
    public function testAddCollection()
    {
        ...
        $this->assertSame(
            ['bar' => $bar, 'foo' => $foo, 'grandchild' => $grandchild, 'last' => $last], $collection->all(),
    ...
    public function testAddDefaultsAndRequirementsAndOptions()
    {
        ...
        $this->assertEquals(
            ['_controller' => 'fixed', 'placeholder' => 'new-default'], $collection->get('bar')->getDefaults(),
        ...
        $this->assertEquals(
            ['placeholder' => '\d+'], $collection->get('bar')->getRequirements(),
    ...
    public function testResource()
    {
        ...
        $this->assertEquals(
            [$foo, $bar], $collection->getResources(),
